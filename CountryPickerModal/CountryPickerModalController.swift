//
//  CountryPickerModalController.swift
//  CountryPickerModal
//
...
public class CountryPickerModalController: UITableViewController {
    ...
    internal weak var countryPickerModal: CountryPickerModal! {
        didSet {
            dataSource = CountryPickerModalDataSourceInternal(view: countryPickerModal)
        }
    }
    
    fileprivate var dataSource: CountryPickerModalDataSourceInternal!
...
// UI Setup
extension CountryPickerModalController {
    
    func prepareTableItems()  {
        
        if !showOnlyPreferredSection {
            
            let countriesArray = countryPickerModal.countries
...
extension CountryPickerModalController {
    ...
    override public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.accessoryType = country == countryPickerModal.selectedCountry ? .checkmark : .none
...
extension CountryPickerModalController {
    ...
    override public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let completion = {
            self.countryPickerModal.didSelectCountry(country)
        }
...
extension CountryPickerModalController: UISearchResultsUpdating {
...
extension CountryPickerModalController: UISearchBarDelegate {
...
extension CountryPickerModalController: UISearchControllerDelegate {
...
// MARK:- An internal implementation of the CountryPickerModalDataSource.
// Returns default options where necessary if the data source is not set.
class CountryPickerModalDataSourceInternal: CountryPickerModalDataSource {
    
    private unowned var view: CountryPickerModal
    
    init(view: CountryPickerModal) {
        self.view = view
    }
